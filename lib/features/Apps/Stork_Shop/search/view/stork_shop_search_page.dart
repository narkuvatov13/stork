...
class StorkShopSearchPage extends ConsumerStatefulWidget {
  const StorkShopSearchPage({super.key});

  @override
  ConsumerState<StorkShopSearchPage> createState() => _StorkShopSearchPageState();
}

class _StorkShopSearchPageState extends ConsumerState<StorkShopSearchPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(body: Center(child: Text('Seacrh Pages')));
  }
}
