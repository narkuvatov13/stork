...
class StorkShopOffersPage extends ConsumerStatefulWidget {
  const StorkShopOffersPage({super.key});

  @override
  ConsumerState<StorkShopOffersPage> createState() => _StorkShopOffersPageState();
}

class _StorkShopOffersPageState extends ConsumerState<StorkShopOffersPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(body: Center(child: Text('Offers Pages')));
  }
}
